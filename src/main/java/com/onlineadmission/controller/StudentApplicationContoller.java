...
public class StudentApplicationContoller {
	...
	public ModelAndView addStudentApplication(HttpServletRequest request, HttpSession session)
		...
		String uploadPath = "E:\\spring boot project\\online-admission\\src\\main\\resources\\studentPics\\"
				+ fileName;
		...
		String webappsPath = "E:\\spring boot project\\online-admission\\src\\main\\resources\\studentPics\\"
				+ fileName;
	...
	public ModelAndView addStudentDocument(HttpServletRequest request, HttpSession session)
		...
		if(document == null) {
			...
			String uploadPath = "E:\\spring boot project\\online-admission\\src\\main\\webapp\\resources\\documents\\"
					+ fileName;
	...
	public void downloadDocument(@RequestParam("studentId") int studentId, @RequestParam("standard") String standard, HttpServletResponse response) throws IOException {
        ...
        File my_file = new File("E:\\spring boot project\\online-admission\\src\\main\\webapp\\resources\\documents\\"+documents.getDocument());
